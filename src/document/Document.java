...
//		String rex = "[^aeiou]*[aeiou]+[^aeiou]*";
//		ArrayList<String> tokens = new ArrayList<String>();
//		Pattern tokSplitter = Pattern.compile(rex);
//		Matcher m = tokSplitter.matcher(word);
//
//		while (m.find()) {
//			tokens.add(m.group());
//		}
////		System.out.println("Token found in a word were "+ tokens);
//		return tokens.size();
	...
	public double getFleschScore()
	{
		...
		int senCount = getNumSentences();
		int syllCount = getNumSyllables();
//		System.out.println("wordCount: "+wordCount);
//		System.out.println("senCount: "+senCount);
//		System.out.println("syllCount: "+syllCount);
		double score = 206.835 - 1.015 * wordCount / senCount - 84.6 * syllCount / wordCount;
